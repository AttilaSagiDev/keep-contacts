...
use Space\KeepContacts\Controller\Adminhtml\Contacts\MassSetIsUnanswered;
...
class MassSetIsUnansweredTest extends TestCase
{
    /**
     * @var MassSetIsUnanswered
     */
    private MassSetIsUnanswered $controller;
    ...
    public function testExecuteSuccess()
    {
        ...
        $this->collectionMock->method('getIterator')->willReturn(new \ArrayIterator([$contactMock]));
    ...
    public function testExecuteWithLocalizedException()
    {
        ...
        $this->collectionMock->method('getSize')
